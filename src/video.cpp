 ...
 * @LastEditTime: 2024-08-23 13:02:33
 * @LastEditors: chentong
 * @Description: 
 * @FilePath: /yolov5_deepsort_tensorrt/src/video.cpp
 * 
 */
...
void InferenceCamere(YOLO& yolo, ObjectTracker& tracker, fastreid& fastreid) {
   
    cv::VideoCapture video_cap(0);
    
    cv::Mat src_img, resize_img;
    ...
    while (video_cap.read(src_img)) {
        ...
        cv::imshow("tracking id", vec_org_img[0]);
